...
Функция ПолучитьТаблицуДокументов(АдресСКД, Компоновщик) Экспорт
	...
	ДоступныеОрганизации = Новый Массив; //УправлениеДоступомБП.ОрганизацииДанныеКоторыхДоступныПользователю("Документ.АктСверкиВзаиморасчетов");
	...
	//а теперь зафигачим здесь вот такой комментарий для проверки
